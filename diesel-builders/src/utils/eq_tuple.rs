...
use diesel_builders_macros::impl_eq_tuple;
...
mod tests {
    ...
    #[test]
    fn test_eq_tuple_unit() {
        let tuple1 = ();
        let tuple2 = ();
        // Call eq_tuple to test it compiles, result is always true
        assert!(tuple1.eq_tuple(&tuple2));
    }

    #[test]
    fn test_eq_tuple_single() {
        let tuple1 = (42,);
        let tuple2 = (42,);
        let tuple3 = (43,);
        assert!(tuple1.eq_tuple(&tuple2));
        assert!(!tuple1.eq_tuple(&tuple3));
    }

    #[test]
    fn test_eq_tuple_two() {
